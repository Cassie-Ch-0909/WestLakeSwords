...
async function getChildCommentDetailsByChildCommentId(
  id,
  childIndex,
  parentIndex,
) {
  ...
  <div class="w-full max-md:hidden">
    ...
    <div class="h50px w-full flex">
      <div class="h-full w-120px flex items-center justify-evenly">
        ...
        <span v-if="loginStatusStore.loginStatusFlag" class="font-size-14px">{{ totalComments + 13 }}</span>
        <span v-else class="font-size-14px color-#fff">23</span>
      </div>
      ...
      <div class="mt15px h-full flex-1">
        ...
        <div class="mt10px font-size-15px">
          ...
          <div class="mt5px font-size-12px color-#9499A0">
            <!-- 评论时间 -->
            <span class="mr20px">2023-09-17&nbsp; 13:30</span>
            <!-- 点赞 -->
            <span class="mr20px">
      ...
      <div class="mt15px h-full flex-1">
        ...
        >
          ...
          <div class="mt5px font-size-12px color-#9499A0">
            ...
            <span
              class="mr20px"
              @click="likeForChildComment(item3.id, index3, index)"
            >
              <i
