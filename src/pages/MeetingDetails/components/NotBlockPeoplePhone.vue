...
<template>
  <div class="container">
    <div class="content ml0px" :style="{ width: `${videoWidth}px`, height: `${videoHeight}px` }">
      <video
    ...
    <div class="bottomBox flex">
      ...
      <!-- <div class=""> -->
      <!-- <span class="mr10px">弹幕</span> -->
      <a-input
        v-model:value="inputText" style="width: 220px;" :placeholder="t('page.AIApplication.sendBarrage')"
        :max-length="20" @keydown="(e: any) => {
          if (e?.key === 'Enter') {
            onSend();
          }
        }
