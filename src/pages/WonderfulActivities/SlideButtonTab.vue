...
// TODO: 调接口根据活动类型查询精彩活动
async function getActivityByType(type?: any) {
  const res = await getActivityByTypeAPI(type)
  // console.log(res)
  btnList.value[activedBtnIndex.value].list = res.data
}
getActivityByType()
