...
import {
  getArticleRankingAPI,
  getAuthorRankingListAPI,
  getRecommandTopicListAPI,
} from '@/apis/hotTopic'
...
<template>
  <div class="mt20px w-21.5% rounded-10px">
    ...
    >
      ...
      <img
        class="w75px cursor-pointer"
        src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/img/sign.d62085a.gif"
        alt=""
      >
    </div>
    <!-- 文章排行榜 -->
    <div class="mt20px h300px w-full flex flex-col bg-#fff">
      <div
        class="h50px w-full flex items-center justify-between border-b-1 border-#E0E0E0 pl15px pr15px"
      >
        ...
        <div
          class="flex items-center color-#999"
          @click="changeArtivleRankings"
        >
          <i class="iconfont icon-huanyihuan mr5px font-size-15px" />
          <p class="cursor-pointer font-size-13px">
            换一换
          </p>
        </div>
      </div>
      <div class="w-full flex-1 border-b-1 border-#E0E0E0 font-size-14px">
        <ul class="h-full w-full flex flex-col justify-evenly">
          <li
            v-for="(item, index) in articleRankingList"
            :key="index"
            class="ml5% mr5% w-90% flex cursor-pointer items-center p5px hover:bg-#E0E0E0"
          >
      ...
      <div
        class="h50px w-full flex cursor-pointer items-center justify-center border-b-1 border-#E0E0E0 color-#999"
      >
    ...
    <!-- 三张海报 -->
    <img src="/public/hottopic/2.jpg" class="mt15px cursor-pointer" alt="">
    <img src="/public/hottopic/3.jpg" class="mt15px cursor-pointer" alt="">
    <img src="/public/hottopic/1.jpg" class="mt15px cursor-pointer" alt="">
    <!-- 作者排行榜 -->
    <div class="mt20px w-full flex flex-col bg-#fff">
      ...
      >
        ...
        <div
          class="flex cursor-pointer items-center color-#999"
          @click="changeAuthorRankingList"
        >
          <i class="iconfont icon-huanyihuan mr5px font-size-15px" />
      ...
      <div class="w-full flex-1 border-b-1 border-#E0E0E0 font-size-14px">
        <ul class="h-full w-full flex flex-col justify-evenly pb10px pt10px">
          <li
            v-for="(item, index) in authorRankingList"
            :key="index"
          ...
          >
            ...
            <div class="cursor-pointer color-blue-400">
              <span>+</span>
              <span>关注</span>
            </div>
          </li>
      ...
      <div class="w-full flex-1 border-b-1 border-#E0E0E0 font-size-14px">
        <ul class="h-full w-full flex flex-col justify-evenly pb5px pt5px">
          <li
            ...
            :key="index"
            class="ml5% mr5% h35px w-90% flex cursor-pointer items-center justify-between p5px hover:bg-#E0E0E0 hover:color-[#00B4BC]"
          >
            <p class="">
              #{{ item.content }}
            </p>
