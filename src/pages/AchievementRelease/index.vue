...
<template>
  ...
  >
    <div class="ml10% mr10% h-full w-80%">
      ...
      <div class="mt50px flex justify-between">
          ...
          >
            ...
            <div class="flex flex-1 flex-col justify-evenly p15px">
              ...
              <div class="h40px w-full flex items-center justify-end">
                <div
                  class="h25px w80px flex items-center justify-center rounded-15px bg-[#2DB1BA] font-size-12px color-[#fff] font-bold"
                >
                  <a
                    target="_blank"
                    href="https://nb.ltcx.cn/image/xhlj/pdf/safe.pdf"
                    download
                  >立即下载</a>
                </div>
              </div>
      ...
      <p class="mt80px font-size-28px color-[#fff] font-bold">
        新品发布
        <span class="font-size-20px">New Product Launch</span>
      </p>
      <div class="mt30px h300px w-full flex justify-between">
        <div
          class="animation-delay-1 bg animate__fadeInLeft wow h-full w47% animate-duration-2500 bg-blue shadow-lg"
        >
          <p
            class="h-30% w-full flex items-center justify-center font-size-24px color-[#fff] font-bold"
          >
            下一代防火墙
          </p>
          <p class="h50% w-full pl-15px pr-15px font-size-14px color-[#fff]">
          ...
          <div
            class="h-20% w-full flex items-center justify-between pl10px pr15px"
          >
            <div
              class="h30px w100px flex items-center justify-center rounded-15px bg-[#2DB1BA] color-[#fff]"
            >
              申请试用
            </div>
            <div class="color-[#002D46] font-bold">
              了解更多
            </div>
          </div>
        </div>
        <div
          class="animation-delay-1 wow animate__fadeInRight bg2 h-full w47% animate-duration-2500 bg-blue shadow-lg"
        >
          <p
            class="h-30% w-full flex items-center justify-center font-size-24px color-[#fff] font-bold"
          >
          ...
          <p class="h50% w-70% pl-15px pr-15px font-size-14px color-[#fff]">
      ...
      <p class="mt80px font-size-28px color-[#fff] font-bold">
        书籍
        <span class="font-size-20px">Books</span>
      </p>
      <div
        class="bg3 mt30px h300px w-full flex flex-col items-center justify-center shadow-lg"
      >
        <p class="font-size-22px color-#2DB1BA font-bold">
          数据安全与隐私计算
        </p>
        <div class="h-70% w-full flex items-center justify-center pl10% pr10%">
          ...
          <div class="font-size-14px">
            ...
            规流通的体系架构，包括数据安全保护技术与保护数据价值释放的隐私计算
            技术，最后针对政务、金融、电力能源、公安行业等重点行业，分析了数据
            安全与数据孤岛现象的根本原因，介绍了数据安全实践案例，以及如何通过
            部署数据要素流通体系架构，打破“数据壁垒”，促进多方数据融合计算的实践案例。
            本书可以作为高校学生、隐私计算技术从业者、数据要素市场从业者、
            数据安全行业从业者的入门读物，也可作为相关机构或组织进行数据要素市
            场流通体系建设实践的参考指南。
          </div>
        </div>
      </div>
  ...
  >
    ...
    <div class="w-full flex flex-col">
      <div
        v-for="(item, index) in whiteBooksList"
        :key="index"
        class="mt10px h120px w-full flex bg-white"
      >
    ...
    <div class="mt10px h180px w-full flex justify-between">
      <div class="bg h-full w49% bg-blue bg-cover shadow-lg">
        <p
          class="h-30% w-full flex items-center justify-center font-size-14px color-[#fff] font-bold"
        >
          下一代防火墙
        </p>
        ...
        >
          <div
            class="h20px w80px flex items-center justify-center rounded-15px bg-[#2DB1BA] font-size-12px color-[#fff]"
          >
            申请试用
          </div>
    ...
    <div
      class="bg3 mt10px h300px w-full flex flex-col items-center justify-center bg-cover shadow-lg"
    >
