...
<template>
  <!-- PC端新闻资讯 -->
  <div class="animation-delay-1 animate__fadeInDown wow ml10% mt[50px] h-[450px] w85% animate-duration-2500 bg-contain bg-left bg-no-repeat max-md:hidden">
    <p class="left-0 top-5% h-[80px] w-80% font-size-[30px] font-bold">
