...
const sevenPM = ref(false)
const eightAM = ref(false)
const eightPM = ref(false)
// 定义方法控制ul的显示隐藏
function changeFiveAM() {
  fiveAM.value = true
  sixPM.value = false
  sevenPM.value = false
  eightAM.value = false
...
<template>
  <div id="body" class="">
    <div id="void" class="void max-md:hidden">
      <div class="crop">
        <!-- 最多支持6个小li -->
        <!-- 5thPM && 6thAM && 7thAM -->
          ...
          <li class="li">
            <div class="card">
              ...
              <div class="card-bottom flex items-center justify-between text-xs">
                ...
                <div
                  class="jusdify-center watch h-[25px] w-33% flex items-center border-2 rounded-[10px] border-solid bg-[#23A2AB]"
                >
                  <i class="iconfont icon-shipinbofang- color-[#fff]" />
                  <p class="text-[#fff]">
                    观看回放
                  </p>
                </div>
          ...
          <li class="li">
            <div class="card">
              ...
              <div class="card-bottom flex items-center justify-between text-xs">
                ...
                <div
                  class="watch jusdify-center h-[25px] w-33% flex items-center border-2 rounded-[10px] border-solid bg-[#23A2AB]"
                >
                  <i class="iconfont icon-shipinbofang- color-[#fff]" />
                  <p class="text-[#fff]">
                    观看回放
      ...
      <div class="mask relative flex flex-col">
        <el-button type="primary" plain class="absolute left-53% top-30%" color="#333" @click="changeFiveAM">
          5th PM
          6th AM
          7th AM
        </el-button>
        ...
        <el-button type="primary" plain class="absolute left-50% top-68%" color="#333" @click="changeEightAM">
          8th AM
        </el-button>
      ...
      <div class="center-circle flex flex-col items-center justify-center from-sky-500 to-indigo-700 bg-gradient-to-r">
        ...
        <div class="mb-[-5px] mt2% color-[#fff]">
          General
        </div>
        <div class="color-[#fff]">
          assembly agenda
